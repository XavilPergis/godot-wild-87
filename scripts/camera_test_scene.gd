...
func _ready() -> void:
	...
	movable_camera.change_target(camera_positions[0], camera_targets[0], 0.0)
	pass
...
func _unhandled_input(event: InputEvent) -> void:
	if event.is_action_pressed("ui_accept"):
		...
		randomize()
		movable_camera.change_target(camera_positions[index], camera_targets[index], randf() + 0.25)
		pass
